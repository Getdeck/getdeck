...
class Deckfile_1_0(Deckfile, BaseModel):
    ...
    def get_deck(self, name: str = None) -> DeckfileDeck:
        if name is None and len(self.decks) > 1:
            raise ValueError(f"Name of Deck is missing and there are multiple Decks available")
            ...
            for deck in self.decks:
                ...
                raise ValueError(f"Name of Deck {name.lower()} is not part of this Deckfile or is missing")
